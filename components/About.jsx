    ...
    >
      ...
      <motion.div
       ...
       className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'>I am an experienced full-stack developer with expertise in creating end-to-end web applications.I have a passion for creating web applications and knack for working on backend projects, including deployment on platforms like Vercel and Railway.</p>
