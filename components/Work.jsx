...
const Work = ({isDarkMode}) => {
  return (
    ...
    id="work" className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my web development portfolio! Explore a collection of projects in full-stack development.</motion.p>
