...
const Services = ({isDarkMode}) => {
  return (
    ...
    id="services" className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a full stack developer from India will soon be joining Infosys as System Engineer.</motion.p>
      <motion.div 
      initial={{opacity:0}}
      whileInView={{opacity:1}}
